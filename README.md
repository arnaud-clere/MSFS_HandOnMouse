...
---------------            | ------------
**5 (Forward) alone**      | **throttle**
**4+5 (Forward+Backward)** | **propeller** or **mixture** or **spoilers** (for jets and gliders)  
**4 (Backward) alone**     | **flaps** (forward-backward move) or **landing gear** (left-right move)
